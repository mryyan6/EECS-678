...
void echoohce(char** strs) {
  ...
  //dereferenced iter pointer when passing to printf
  ...
  // wrong.
  //changed end condition to the beginning of iter
...
int main(int argc, char** argv) {
  ...
  // initialized num_bugs_on_mars to 0
  ...
  // free memory of before reassigning
  ...
  // pass the 6th element instead of the 2nd
  //because the 2nd has already been freed 
